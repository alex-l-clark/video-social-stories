...
from social_story.settings import has_all_keys, ALLOWED_ORIGINS
from social_story.models import StoryRequest
from social_story.orchestrator import run_pipeline
from typing import Optional
import asyncio
from social_story.utils import safe_open_binary
...
# --- Simple in-memory job registry for MVP ---
JOBS = {}
...
async def start_job(req: StoryRequest):
    ...
    try:
        ...
        # This ensures all API calls (OpenAI, Replicate, ElevenLabs) actually execute
        final_state = await run_pipeline(req)
...
# Removed unused KV functions for MVP - will add back when scaling
